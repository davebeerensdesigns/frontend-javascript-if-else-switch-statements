...
// ==========================================
const higherNumber = 10 > 20;
console.log("is 10 groter dan 20?", higherNumber);
...
// ==========================================
const falseNumbers = 10 !== 11;
console.log('Is 10 ongelijk aan 11?', falseNumbers);
...
console.log('zijn zoet en sappig hetzelfde?', sameWords);
...
// ==========================================
const score = 9;
if (score > 8) console.log('Cum laude!');
...
if(!isRaining && temperature > 21) console.log('Je kunt een korte broek aan!');

isRaining = true;
if(isRaining || temperature < 12) console.log('Doe je jas aan!');
